...
import GoogleSignIn from "./GoogleAuthentication";
...
export default function SignUp() {
  ...
  const [request, response, promptAsync] = Google.useIdTokenAuthRequest({
    clientId: process.env.EXPO_PUBLIC_CLIENT,
  });
  useEffect(() => {
  ...
  return (
    <View style={{ gap: 10 }}>
      <Text style={{ color: secondary, fontSize: 40, fontWeight: "600" }}>
        Sign Up Anonymously
      </Text>
      ...
      >
        ...
        <View>
          ...
          >
            You will just be connected to other users, to use the app in
            multiple devices, go to profile and complete sign up.
          </Text>
        </View>
      </View>
    </View>
