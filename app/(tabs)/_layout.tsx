...
export default function TabLayout() {
  ...
  const handleChatValue = (chatId: string, user: string) => {
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: "Chats",
          tabBarIcon: ({ color }) => (
            <TabBarIcon name="group" color={color} number={nouc} />
          ),
